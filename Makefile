...
pkgdatadir = $(datadir)/mbmt
pkglibdir = $(libdir)/mbmt
pkgincludedir = $(includedir)/mbmt
...
am_mbmt_create_test_OBJECTS = src/mbmt-create-test.$(OBJEXT)
mbmt_create_test_OBJECTS = $(am_mbmt_create_test_OBJECTS)
mbmt_create_test_LDADD = $(LDADD)
am_mbmt_create_training_OBJECTS = src/mbmt-create-training.$(OBJEXT)
mbmt_create_training_OBJECTS = $(am_mbmt_create_training_OBJECTS)
mbmt_create_training_LDADD = $(LDADD)
am_mbmt_decode_OBJECTS = src/sockhelp.$(OBJEXT) \
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = mbmt
PACKAGE_STRING = mbmt 0.1
PACKAGE_TARNAME = mbmt
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
SHELL = /bin/sh
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/mbmt-create-test.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
mbmt-create-test$(EXEEXT): $(mbmt_create_test_OBJECTS) $(mbmt_create_test_DEPENDENCIES) 
	@rm -f mbmt-create-test$(EXEEXT)
	$(LINK) $(mbmt_create_test_OBJECTS) $(mbmt_create_test_LDADD) $(LIBS)
src/mbmt-create-training.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
mbmt-create-training$(EXEEXT): $(mbmt_create_training_OBJECTS) $(mbmt_create_training_DEPENDENCIES) 
	@rm -f mbmt-create-training$(EXEEXT)
	$(LINK) $(mbmt_create_training_OBJECTS) $(mbmt_create_training_LDADD) $(LIBS)
src/sockhelp.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/mbmt-decode.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
